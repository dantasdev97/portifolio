...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  function handleNavigate(href: string) {
    ...
    // Se estiver na página de detalhes do projeto, voltar para a página inicial
    if (pathname.startsWith("/portfolio/")) {
      router.push("/")
      // Aguardar a navegação e depois scrollar para a seção com animação suave
      setTimeout(() => {
    ...
    // Animação suave e lenta para navegação
    smoothScrollToSection(id)
  }
    ...
    <html lang="pt-BR" className={`${spaceGrotesk.variable} ${poppins.variable}`}>
      <body className="flex md:items-center md:justify-center h-auto md:h-screen w-screen bg-background text-foreground overflow-x-hidden font-poppins">
        ...
        <div className="flex flex-row items-center justify-center max-w-7xl w-full mx-auto md:min-h-screen relative z-10">
          ...
          <main className={`hidden md:block overflow-y-auto max-w-3xl w-full mx-auto transition-all duration-500 ease-out ${
          ...
          <div className="flex flex-col md:hidden w-full min-h-screen">
              ...
              <header className="p-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  <div className="relative">
                    ...
                    />
                    {/* Fallback Avatar */}
                    <div className="w-12 h-12 rounded-full bg-green-600 border-2 border-green-500 items-center justify-center text-white font-bold text-lg hidden">
                      AD
                    </div>
                  </div>
                  <div>
                    ...
                    >
                      ...
                      <p className="text-green-500 text-sm font-medium animate-pulse font-poppins">
            ...
            {/* Menu Mobile - sempre presente, controlado por CSS */}
            <div
            ...
            >
              {pathname.startsWith("/portfolio/") ? (
                ...
                <div className="min-h-[calc(100vh-120px)] bg-[#1D252B] ">
                  {children}
                </div>
              ) : (
                <>
                  ...
                  <section id="portfolio" className="min-h-[450px] mt-3 scroll-mt-20 transition-all duration-700 ease-out">
                    {/* Renderiza a lista de projetos no mobile */}
                    <PortfolioPage />
                  </section>
